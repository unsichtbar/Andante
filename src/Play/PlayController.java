...
public class PlayController {
    ...
    private void handleQuestions() {
        ...
        if(currentQuestion != null)
        {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Main/main_menu.fxml"));
                ...
                URL resource = getClass().getResource("/res/sounds/harp.mp3");
    ...
    public void setQuestionImages()
    {
        ...
        backgroundImage1 = new BackgroundImage( new Image( getClass().getResource("/res/pictures/" +answer1).toExternalForm()), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, BackgroundSize.DEFAULT);
        Background background1 = new Background(backgroundImage1);
        this.choice1Button.setBackground(background1);
        // option 2
        String answer2 = q.getAnswers().get(1).getContent();
        backgroundImage2 = new BackgroundImage( new Image( getClass().getResource("/res/pictures/" +answer2).toExternalForm()), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, BackgroundSize.DEFAULT);
        Background background2 = new Background(backgroundImage2);
        this.choice2Button.setBackground(background2);
        //option 3
        String answer3 = q.getAnswers().get(2).getContent();
        backgroundImage3 = new BackgroundImage( new Image( getClass().getResource("/res/pictures/" +answer3).toExternalForm()), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, BackgroundSize.DEFAULT);
